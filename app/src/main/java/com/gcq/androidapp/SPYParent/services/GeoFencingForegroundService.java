...
import com.gcq.androidapp.SPYParent.activities.ParentSignedInActivity;
...
public class GeoFencingForegroundService extends Service {
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		Notification notification = new NotificationCompat.Builder(this, CHANNEL_ID).setContentTitle(notificationContent).setSmallIcon(R.drawable.ic_spyparent).addAction(R.drawable.ic_cancel, getString(R.string.stop), stopPendingIntent).setContentIntent(pendingIntent).build();
